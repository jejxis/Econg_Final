...
class CommunityAdapter(val context: Context?): RecyclerView.Adapter<CommunityAdapter.CommunityHolder>(){
    var listData = mutableListOf<Community>()//어댑터에서 사용할 목록변수
    ...
    fun setData(arrData : MutableList<Community>?){
        listData = arrData as ArrayList<Community>
    }
